...
#warning "You must fill in your own app Id here"
    self.ptController = [[[PTController alloc] initWithAppId:@"Your App ID"] autorelease];
...
{    
    return [_ptController handleOpenURL:url];
}
